...
const SelectComponent = (props) => {
  ...
  const [localBrandList, setLocalBrandList] = React.useState(props.brandList);
...
const BrandWidget = () => {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(ui.Container, { className: "divide-y p-0", children: [
    ...
    /* @__PURE__ */ jsxRuntime.jsx(
      ...
      {
        title: "Brand",
        value: ((_b = (_a = data == null ? void 0 : data.product) == null ? void 0 : _a.brand) == null ? void 0 : _b.name) ? /* @__PURE__ */ jsxRuntime.jsx(
          OrganizationTag,
          {
